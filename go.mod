...
require (
	...
	github.com/brotherlogic/githubcard v0.0.0-20220524132420-3efd1c17ae23 // indirect
	...
	github.com/brotherlogic/recordsorganiser v0.0.0-20220524164032-7f1fbff003dd
